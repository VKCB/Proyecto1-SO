...
Car carros_izquierda[] = {
    ...
    {0, 1, 4, 0, 0, LUGAR_IZQUIERDA, TIPO_PRIORITARIO, 80.0f, 3, 0, 0, 0, 0, 0.0f}  // Cambiado NULL a 0
};
...
Car carros_derecha[] = {
    {0, 1, 1, 0, 0, LUGAR_DERECHA, TIPO_PRIORITARIO, 80.0f, 1, 0, 0, 0, 0, 0.0f},  // Cambiado NULL a 0
    {0, 1, 2, 0, 0, LUGAR_DERECHA, TIPO_NORMAL, 40.0f, 1, 0, 0, 0, 0, 0.0f},  // Cambiado NULL a 0
    {0, 1, 3, 0, 0, LUGAR_DERECHA, TIPO_SPORT, 60.0f, 1, 0, 0, 0, 0, 0.0f},   // Cambiado NULL a 0
    {0, 1, 3, 0, 0, LUGAR_DERECHA, TIPO_PRIORITARIO, 80.0f, 1, 0, 0, 0, 0, 0.0f}   // Cambiado NULL a 0
};
